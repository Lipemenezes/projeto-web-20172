...
-- INSERE AS PESSOAS
INSERT INTO PESSOA
VALUES (1, 'Edson', 'Arantes do Nascimento', 1, 'edson', 'senha', 1, '000.000.000-00');

INSERT INTO PESSOA
VALUES (2, 'Arhur', 'Antunes Coimbra', 2, 'zico', 'senha', 2, '111.111.11-11');

INSERT INTO PESSOA
VALUES (3, 'Manoel', 'Francisco dos Santos', 3, 'garrincha', 'senha', '222.222.222-22');

INSERT INTO PESSOA
VALUES (4, 'Mário', 'Jorge Lobo Zagallo', 1, 'lobo', 'senha', 1, '333.333.333-33');

INSERT INTO PESSOA
VALUES (5, 'Eduardo', 'Gonçalves de Andrade', 4, 'tostao', 'senha', 2, '444.444.444-44');
COMMIT;